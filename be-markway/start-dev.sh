...
JWT_AUTHORITY=http://$LAN_IP_ADDRESS:5353/
...
echo JWT_AUTHORITY=http://identity-api:5353/ >> .env.dev
...
echo EMAILSERVER_PASSWORD=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 >> .env.dev
