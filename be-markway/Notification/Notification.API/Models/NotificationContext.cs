...
namespace Markway.Notification.API.Models
{
    public class NotificationContext : DbContext
    {
        ...
        public NotificationContext(DbContextOptions<NotificationContext> options, SystemConfiguration systemConfiguration) : base(options)
        {
