        ...
        <FormControl fullWidth>
            <InputLabel id="demo-simple-select-label" error={props.error}>{props.label}</InputLabel>
            {
                ...
                <Controller
                    ...
                    render={({ field }) =>
                        ...
                        >
                            {getDropdownOptions(props.options, props.nameKey, props.valueKey, props.selectOptions, props.imgKey, false, props.addCarrier)}
                        </Select>}
                />
            }
            {
                ...
                >
                    {getDropdownOptions(props.options, props.nameKey, props.valueKey, props.selectOptions)}
                </Select>
            }

            {
                ...
                <Select
                    ...
                    IconComponent={() => (props.iconPath ? <img src={props.iconPath} /> : <ArrowDropDownIcon />)}
                >
                    {getDropdownOptions(props.options, props.nameKey, props.valueKey, props.selectOptions, props.disableMenuItem)}
                </Select>
            }
