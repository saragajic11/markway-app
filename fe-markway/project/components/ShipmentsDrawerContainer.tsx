...
const ShipmentsDrawerContainer = ({
    ...
    return <FormProvider {...form}>
        <form id="shipments-form" className="shipments-form" onSubmit={onSubmit}>
            ...
            <TextField label="Količina robe" type="number" InputProps={{
                inputProps: { min: 0 }
            }} />
            <TextField label="Priliv" type="number" InputProps={{
                inputProps: { min: 0 }
            }} />
            ...
            <SelectControl name='carrier' value={values['carrier']} setValue={setValue} control={control} label={'Prevoznik'} options={listOfCarriers} nameKey={'name'} valueKey={'id'} addCarrier={addCarrier} />
            <TextField label="Odliv" type="number" InputProps={{
                inputProps: { min: 0 }
            }} />
            ...
            <TextField label="Profit" type="number" InputProps={{
                inputProps: { min: 0 }
            }} />
